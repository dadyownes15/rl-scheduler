...
def ppo(workload_file, model_path, ac_kwargs=dict(), seed=0,
        ...
        shuffle=False,
        backfil=False, skip=False, job_score_type=0, user_score_type=0, batch_job_slice=0):
    ...
    env = HPCEnvFair(shuffle=shuffle, backfil=backfil, skip=skip, job_score_type=job_score_type, 
                user_score_type=user_score_type, batch_job_slice=batch_job_slice, build_sjf=False)
    env.seed(seed)
...
if __name__ == '__main__':
    ...
    if args.pre_trained:
        ...
        ppo(workload_file, args.model, gamma=args.gamma, seed=args.seed, traj_per_epoch=args.trajs, epochs=args.epochs,
            logger_kwargs=logger_kwargs, pre_trained=1, trained_model=str(Path(model_file)/"simple_save"),
            attn=args.attn,
            shuffle=args.shuffle, backfil=args.backfil, skip=args.skip, job_score_type=args.job_score_type, 
            user_score_type=args.user_score_type,
        ...
        ppo(workload_file, args.model, gamma=args.gamma, seed=args.seed, traj_per_epoch=args.trajs, epochs=args.epochs,
            ...
            skip=args.skip, job_score_type=args.job_score_type, user_score_type=args.user_score_type, batch_job_slice=args.batch_job_slice)
